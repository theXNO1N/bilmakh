...
<div class="d-flex flex-column align-items-center justify-content-center">
    <img src="../assets/img/questions/question4.jpg" width="300px" class="rounded rounded-5" alt="">
    <h3>چگونه با استرس مواجه می شوید؟</h3>
</div>
<select required name="score" class="form-select" size="2">
  <option value="$num[0]" >من سعی می کنم با ورزش و فعالیت های بدنی استرس را کاهش دهم.</option>
  <option value="$num[1]" >من سعی می کنم با مطالعه، موسیقی گوش دادن یا هنر استرس را کاهش دهم.</option>
</select>
<br>
